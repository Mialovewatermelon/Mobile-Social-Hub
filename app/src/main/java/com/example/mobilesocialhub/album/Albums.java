...
//        pestDection=super.findViewById(R.id.pestDetection);
        ...
        pictureSave.setOnClickListener(new backtoMainFunction());
...
//    }
    ...
    private class backtoMainFunction implements View.OnClickListener{

        @Override
        public void onClick(View view) {
            intent2 = new Intent(getApplicationContext(),MainActivity.class);
            intent2.putExtra("url",pathForMain);
